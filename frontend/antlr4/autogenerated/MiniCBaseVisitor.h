...
public:
  ...
  virtual std::any visitLogicalOrOp(MiniCParser::LogicalOrOpContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitLogicalAndOp(MiniCParser::LogicalAndOpContext *ctx) override {
    return visitChildren(ctx);
  }
